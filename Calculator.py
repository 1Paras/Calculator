...
f = Frame(root, bg="grey")
b = Button(f, text="0", padx=31, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)

b = Button(f, text="-", padx=31, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)
...
b = Button(f, text="=", padx=27, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)
...
f = Frame(root, bg="grey")
b = Button(f, text="C", padx=26, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)

b = Button(f, text=".", padx=26, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)

b = Button(f, text="00", padx=14, pady=8, font="lucida 35 bold")
b.pack(side=LEFT, padx=8, pady=5)
b.bind("<Button-1>", click)
